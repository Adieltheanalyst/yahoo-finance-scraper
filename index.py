...
driver.get("https://finance.yahoo.com/research-hub/screener/index")
    ...
    try:
        ...
        for row in rows:
            try:
                ...
                etf['1D_Chart'] = row.find_element(By.CSS_SELECTOR, "td:nth-child(4) a").get_attribute("href")
                etf['Price_intraday'] = row.find_element(By.CSS_SELECTOR, ".tw-min-w-20+ .yf-11hlglb fin-streamer").text
                etf['Change'] = row.find_element(By.CSS_SELECTOR, ".row .yf-11hlglb:nth-child(6) .txt-positive").text
                etf['Change_pct'] = row.find_element(By.CSS_SELECTOR, ".row .yf-11hlglb:nth-child(7) .txt-positive").text
