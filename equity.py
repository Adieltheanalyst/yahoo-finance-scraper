    ...
    try:
        ...
        for row in rows:
            try:
                ...
                etf['company_url'] = row.find_element(By.CSS_SELECTOR, "a.ticker").get_attribute("href")
                ...
                etf['Price_intraday'] = row.find_element(By.CSS_SELECTOR, ".tw-min-w-20+ .yf-11hlglb fin-streamer").text
                etf['Change'] = row.find_element(By.CSS_SELECTOR, ".row .yf-11hlglb:nth-child(6) span").text
                etf['Change_pct'] = row.find_element(By.CSS_SELECTOR, ".row .yf-11hlglb:nth-child(7) span").text
                etf['Volume'] = row.find_element(By.CSS_SELECTOR, ".row .yf-11hlglb:nth-child(8)").text
                etf['Avg_Vol(3M)'] = row.find_element(By.CSS_SELECTOR, ".row .yf-11hlglb:nth-child(9)").text
                etf['Market_Cap'] = row.find_element(By.CSS_SELECTOR, ".row .yf-11hlglb:nth-child(10)").text
                etf['P/E_Ratio(TTM)'] = row.find_element(By.CSS_SELECTOR, ".yf-11hlglb > span").text
...
json_filename = 'equity_data.json'
